@echo off
title Restablecer Base de Datos - Centros InfoSystem - Anti-Gravity
cd /d "%~dp0"
...
echo a importar la copia de produccion (db.sql.gz).
echo.
...
echo.
echo Tu web estara disponible en: http://localhost:8080
echo.
pause
