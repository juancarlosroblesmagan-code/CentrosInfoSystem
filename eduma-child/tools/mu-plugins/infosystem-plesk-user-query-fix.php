<?php
/**
 * Plugin Name: Infosystem — Fix listado usuarios Plesk / WP-CLI
 * Description: WordPress trac #62003 — caché incorrecta en WP_User_Query.
 * Version: 1.2.0
 * Author: Infosystem
 *
 * Subir a: wp-content/mu-plugins/infosystem-plesk-user-query-fix.php
 */
 ...
 */
function infosystem_plesk_disable_user_query_cache( $query ) {
...
add_filter(
	...
	static function ( $null, $query ) {
		infosystem_plesk_disable_user_query_cache( $query );
		return $null;
	},
	1,
	2
