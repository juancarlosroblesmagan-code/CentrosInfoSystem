...
function antigravity_inyectar_esquema_localbusiness() {
    ...
    $logo_url = 'https://centrosinfosystem.com/wp-content/uploads/2020/03/centrosinfosystem-logo-dark.png';

    $schema = array(
        '@context'    => 'https://schema.org',
        '@type'       => 'LocalBusiness',
        'name'        => 'Centros InfoSystem',
        'image'       => $logo_url,
        'telephone'   => '+34 926 33 11 62',
        'email'       => 'info@centrosinfosystem.com',
        'url'         => 'https://centrosinfosystem.com',
        'priceRange'  => '$$',
        'address'     => array(
            '@type'           => 'PostalAddress',
        ...
        'sameAs' => array(
            'https://www.facebook.com/centrosinfosystem'
        ),
        'description' => 'Centros InfoSystem - Especialistas en Formación Profesional y Cursos Subvencionados para el Empleo.'
    );

    echo "\n<!-- Esquema LocalBusiness de Centros InfoSystem (Anti-Gravity) -->\n";
...
function antigravity_inyectar_esquema_curso() {
    ...
    $schema = array(
        ...
        'provider'    => array(
            '@type'  => 'Organization',
            'name'   => 'Centros InfoSystem',
            'sameAs' => 'https://centrosinfosystem.com'
        )
    );
