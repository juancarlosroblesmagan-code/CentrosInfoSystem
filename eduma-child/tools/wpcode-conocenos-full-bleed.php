<?php
/**
 * WPCode — Conócenos: fondos de sección a ancho completo.
 * Tipo: PHP snippet, ejecutar en todas partes.
 */
...
add_action(
	...
	static function () {
		...
		?>
		<style id="infosystem-conocenos-full-bleed">
			body.page-id-16705 {
				overflow-x: hidden;
			}
			...
			body.page-id-16705 .cis-about-cta-final {
				margin-bottom: 0 !important;
			}
			body.page-id-16705 .container.sidebar-right.site-content,
			body.page-id-16705 #main-content,
			body.page-id-16705 .site-content {
				padding-bottom: 0 !important;
				margin-bottom: 0 !important;
			}
			body.page-id-16705 #colophon,
			body.page-id-16705 footer#colophon {
