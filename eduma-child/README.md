...
Child theme para **Infosystem** (Eduma) con rendimiento, asistente de páginas y limpieza del demo.

**Despliegue en el servidor:** [`docs/DEPLOY-INFOSYSTEM.md`](docs/DEPLOY-INFOSYSTEM.md)
