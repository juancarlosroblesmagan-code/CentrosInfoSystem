<?php
/**
 * Contenido HTML de páginas institucionales Infosystem.
 *
 * @package eduma-child
 */
 ...
 */
function eduma_child_infosystem_page_definitions() {
	...
	return array(
		'conocenos' => array(
			'title'   => 'Conócenos',
			'slug'    => 'conocenos',
			'content' => eduma_child_infosystem_content_conocenos( $phone, $email, $address ),
		),
		'contacto'  => array(
			'title'   => 'Contacto',
			'slug'    => 'contacto',
			'content' => eduma_child_infosystem_content_contacto( $phone, $email, $address ),
		),
		'faqs'      => array(
			'title'   => 'Preguntas frecuentes',
			'slug'    => 'faqs',
			'content' => eduma_child_infosystem_content_faqs(),
		),
		'trabaja'   => array(
			'title'   => 'Trabaja con nosotros',
			'slug'    => 'trabaja-con-nosotros',
			'content' => eduma_child_infosystem_content_trabaja( $email ),
		),
		'privacidad' => array(
			'title'   => 'Política de privacidad',
			'slug'    => 'politica-de-privacidad',
			'content' => eduma_child_infosystem_content_privacidad( $email ),
		),
		'aviso'     => array(
			'title'   => 'Aviso legal',
			'slug'    => 'aviso-legal',
			'content' => eduma_child_infosystem_content_aviso( $email, $address ),
		),
	);
}
 ...
 * @return string
 */
function eduma_child_infosystem_content_conocenos( $phone, $email, $address ) {
	ob_start();
	?>
	<div class="infosystem-page infosystem-page--about">
		<p class="infosystem-lead">Desde 2007, <strong>Infosystem — Centro de Educación Polivalente</strong> impulsa la formación para el empleo en Castilla-La Mancha con cursos gratuitos y bonificados para trabajadores, desempleados y empresas.</p>
		...
		<p><a class="infosystem-cta" href="<?php echo esc_url( home_url( '/cursos-gratis/' ) ); ?>">Ver cursos gratuitos</a> · <a class="infosystem-cta infosystem-cta--ghost" href="<?php echo esc_url( home_url( '/contacto/' ) ); ?>">Solicitar información</a></p>
	</div>
	<?php
 ...
 * @return string
 */
function eduma_child_infosystem_content_contacto( $phone, $email, $address ) {
	ob_start();
	?>
	<div class="infosystem-page infosystem-page--contact">
		<p class="infosystem-lead">¿Tienes dudas sobre requisitos, plazas o convocatorias? Escríbenos o llámanos y te orientamos sin compromiso.</p>
		<div class="infosystem-contact-grid">
			<div>
 ...
 * @return string
 */
function eduma_child_infosystem_content_faqs() {
	ob_start();
	?>
	<div class="infosystem-page infosystem-page--faqs">
		<h2>Preguntas frecuentes</h2>
		<div class="infosystem-faq">
 ...
 * @return string
 */
function eduma_child_infosystem_content_trabaja( $email ) {
	ob_start();
	?>
	<div class="infosystem-page infosystem-page--jobs">
		<p class="infosystem-lead">¿Te apasiona la formación? Buscamos tutores, coordinadores y personal administrativo en Castilla-La Mancha.</p>
 ...
 * @return string
 */
function eduma_child_infosystem_content_privacidad( $email ) {
	ob_start();
	?>
	<div class="infosystem-page infosystem-page--legal">
		<h2>Política de privacidad</h2>
		<p><em>Texto base. Debe revisarse por asesoría legal antes de publicación definitiva.</em></p>
		<p>El responsable del tratamiento es Centro de Educación Polivalente Infosystem. Puedes ejercer tus derechos de acceso, rectificación, supresión y otros escribiendo a <a href="mailto:<?php echo esc_attr( $email ); ?>"><?php echo esc_html( $email ); ?></a>.</p>
 ...
 * @return string
 */
function eduma_child_infosystem_content_aviso( $email, $address ) {
	ob_start();
	?>
	<div class="infosystem-page infosystem-page--legal">
		<h2>Aviso legal</h2>
		<p><em>Texto base. Debe revisarse por asesoría legal antes de publicación definitiva.</em></p>
		<p><strong>Titular:</strong> Centro de Educación Polivalente Infosystem<br>
