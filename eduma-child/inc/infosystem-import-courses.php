 ...
 * Si el remoto falla, usa el HTML local de inc/infosystem-course-content.php.
 *
 * @package eduma-child
 */
...
add_action(
	...
	static function () {
		...
		echo '<div class="notice notice-warning"><p><strong>Infosystem:</strong> ';
...
function eduma_child_sync_courses_from_premium() {
	...
	if ( function_exists( 'infosystem_apply_course_featured_images' ) ) {
		$out['course_images'] = infosystem_apply_course_featured_images();
	} else {
...
/**
 * Asigna fotos centrosinfosystem a los productos CLM (child theme, sin mu-plugin).
 *
 * @return array<string, mixed>
 */
function eduma_child_apply_course_featured_images() {
	$map = array(
		'curso-de-gestion-de-negocios-online-2-0-clm'     => 'centrosinfosystem-5',
		'curso-ofimatica-en-la-nube-con-google-drive'     => 'centrosinfosystem-6',
		'curso-ofimatica-en-la-nube-con-google-drive-clm' => 'centrosinfosystem-6',
	);
	$results = array();
...
function eduma_child_import_product_from_local( $slug, $cat_id ) {
	$local = array(
		'curso-de-gestion-de-negocios-online-2-0-clm'   => array(
			...
			'image'   => content_url( '/uploads/2026/05/centrosinfosystem-5.webp' ),
		...
		'curso-ofimatica-en-la-nube-con-google-drive'   => array(
			...
			'image'   => content_url( '/uploads/2026/05/centrosinfosystem-6.webp' ),
