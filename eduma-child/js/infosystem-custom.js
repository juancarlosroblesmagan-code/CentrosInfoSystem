...
(function($) {
    ...
    // ============================================================    $(document).ready(function() {
        ...
        infosystem_setupAccordionTexts();
        infosystem_collapseAccordion();
        infosystem_setupHomepageEvents();
    });
    ...
    // ============================================================
    function infosystem_setupAccordionTexts() {
    ...
    // ============================================================
    function infosystem_setupHomepageEvents() {
        var $eventsContainer = $('[data-id="d87535a"]');
        if (!$eventsContainer.length) return;

        var contactUrl = '/contacto/';
        var eventsHtml = ' \
            <div class="infosystem-home-events-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px; width: 100%; margin-top: 20px; box-sizing: border-box;"> \
                <div class="infosystem-home-event-card" style="background: #ffffff; border: 1px solid #efe2e2; border-radius: 12px; padding: 24px; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 4px 18px rgba(139,26,26,0.03); transition: all 0.3s ease; box-sizing: border-box; min-height: 250px;"> \
                    <div> \
