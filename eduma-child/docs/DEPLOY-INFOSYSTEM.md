# Desplegar y finalizar Infosystem en Plesk
...
## 3. Ejecutar el asistente Infosystem

1. **Apariencia → Infosystem Setup**
...
- `/aviso-legal/`
- Menú **Infosystem Principal** (sin mega menú demo)
...
**Páginas → Demo Main Infosystem (o la página de inicio) → Editar con Elementor**
...
- Cambia autor "CursosPremium" por **Infosystem** en usuarios.
...
## 10. Dominio definitivo (infosystem.net)

Dominio provisional actual: `friendly-sutherland.5-175-47-192.plesk.page`  
Dominio final: **infosystem.net**

En Plesk, cuando el DNS apunte a infosystem.net:

1. Asigna **infosystem.net** como dominio principal del sitio
2. **Ajustes → Generales** → cambia ambas URLs a `https://infosystem.net`
...
define( 'INFOSYSTEM_SITE_URL', 'https://infosystem.net' );
```

El child theme incluye filtros en `inc/infosystem-domain.php` para esas constantes.
