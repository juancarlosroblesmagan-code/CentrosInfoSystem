# 🎓 GUÍA DE INSTALACIÓN — INFOSYSTEM
## Centro de Educación Polivalente
## infosystem.net · Santa Cruz de Mudela, Ciudad Real
...
3. Nombre sugerido: `demo.infosystem.net` o `infosystem.friendly-sutherland.5-175-47-192.plesk.page`
4. Crea una base de datos nueva:
   - Nombre: `infosystem_wp`
   - Usuario: `infosystem_usr`
...
## PASO 4 — INSTALAR EL CHILD THEME DE INFOSYSTEM

1. Sube la carpeta `infosystem-child/` a: `/wp-content/themes/`
2. En WordPress: **Apariencia → Temas**
3. Activa **"Infosystem Child"**
...
- ✅ Shortcodes: `[infosystem_phone]`, `[infosystem_email]`, `[infosystem_address]`
...
- Título del sitio: `Infosystem — Centro de Educación Polivalente`
...
- Sube el logo de Infosystem (PNG con fondo transparente, mín. 300px de ancho)
- Sube también el favicon (ICO o PNG 32x32)

### 5.3 Colores (si quieres ajustar)
- Ve a **Apariencia → Personalizar → Infosystem — Configuración → Colores Corporativos**
- Puedes cambiar los HEX de granate y dorado sin tocar código

### 5.4 Datos de contacto
- Ve a **Apariencia → Personalizar → Infosystem — Configuración → Datos de Contacto**
...
| Nosotros        | Historia de Infosystem, foto directora, misión/visión |
...
- "Cursos Premium" → "Infosystem"
- "cursospremiumonline.es" → "infosystem.net"  
- "910 785 785" → "926 33 11 62"
- "hola@cursospremiumonline.es" → "info@infosystem.net"
...
### Tu web tiene 3 planes. Para Infosystem serían:

| Plan Original (cursospremium) | Plan Infosystem                    |
|-------------------------------|------------------------------------|
...
| Yoast SEO / Rank Math   | Configurar datos de Infosystem en SEO               |
| Contact Form 7          | Actualizar email de destino a info@infosystem.net   |
| Cookie plugin           | Actualizar política de privacidad con datos de Infosystem |
...
- **Nombre del sitio**: Infosystem — Centro de Educación Polivalente
...
```
[infosystem_phone]   → +34 926 33 11 62 (enlace clickeable en móvil)
[infosystem_email]   → info@infosystem.net (enlace mailto)
[infosystem_address] → C. Cruz de Piedra, 13 · Santa Cruz de Mudela, CR
```
...
├── js/
│   └── infosystem-custom.js  ← Animaciones, sticky header, scroll suave
└── images/
...
---
*Documento generado automáticamente — Infosystem Child Theme v1.0.0*
